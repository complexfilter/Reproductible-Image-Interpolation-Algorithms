...
if im_num == 1
   options.deta =0.001;
   original_HRImg = double(imread('.\test_images\HR_airplane.tif'));
end

if im_num == 2
   options.deta =0.001;
   original_HRImg = double(imread('.\test_images\HR_lena.pgm'));
end


if im_num == 3
   options.deta =0.01;
   original_HRImg = double(imread('.\test_images\HR_flowers.tif'));
end

if im_num == 4
   options.deta =0.01;
   original_HRImg = double(imread('.\test_images\HR_girl.tif'));
end

if im_num == 5
   options.deta =0.001;
   original_HRImg = double(imread('.\test_images\HR_door.tif'));
end

if im_num == 6
   options.deta =0.001;
   original_HRImg = double(imread('.\test_images\HR_peppers.tif'));
end

if im_num == 7
   options.deta =0.01;
   original_HRImg = double(imread('.\test_images\HR_splash.tif'));
end

if im_num == 8
   options.deta =0.1;
   original_HRImg = double(imread('.\test_images\baboon256.bmp'));
end

if im_num == 9
   options.deta =0.001;
   original_HRImg = double(imread('.\test_images\tower300.png'));

end

if im_num == 10
   options.deta =0.01;
   original_HRImg = double(imread('..\test_images\HR_butterfly.bmp'));
end
% %%%%%%%%%%%%%%%%%%%%%%%%
...
options.weight_fg = 1;%%´ú±íÓÃbilateral weights
